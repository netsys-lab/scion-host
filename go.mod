...
require github.com/netsec-ethz/bootstrapper v0.0.7
...
replace github.com/netsec-ethz/bootstrapper => /home/marten/go/src/github.com/martenwallewein/bootstrapper
